...
--Listing 11.2Three functions for making datetimes from components
 SELECT make_date(2018, 2, 22);
 SELECT make_time(18, 4, 30.3); 
SELECT make_timestamptz(2018, 2, 22, 18, 4, 30.3, 'Europe/Lisbon');

--Listing 11.3Comparing current_timestamp and clock_timestamp() during row insert
...
--Listing 11.12 Calculating the length of each trip segme
SELECT segment,
