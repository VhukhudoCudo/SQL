...
CREATE TABLE zip_codes (
	zip_code char(4) PRIMARY KEY CHECK (LENGTH(zip_code) = 4 ), --IS CHECK CONSTRAINT NECCESARY WHEN CHAR(4) IS USED ?
	province varchar(20),
	city varchar(25)
);
...
VALUES 
	('0713', 'Limpopo', 'Polokwane'),
	('0920', 'Limpopo', 'Louis Trichardt'),
...
CREATE TABLE professions (
	...
	CONSTRAINT UC_profession UNIQUE (profession) -- SHOULD THIS CONSTARINT BE IN THIS TABLE OR THE my_contacts TABLE ?
);
...
------TESTING Constraint My_Contact---------
INSERT INTO my_contacts (
	first_name, last_name, gender, phone, email, birthday,
	zip_code, status_id, profession_id
)
VALUES (
	'Test', 'User', 'M', '080 000 0000', 'testuser@example.com', '1990-01-01',
	'0713', 999, 1
);
-----------
...
VALUES 
	('Ellis', 'Richards', 'M', '082 227 5732', 'EllisRichards@armyspy.com', '1983-02-18', '0713', 2, 1),
	...
	('Kian', 'Stewart', 'M', '083 401 0877', 'KianStewart@rhyta.com', '1983-04-13', '0001', 2, 8),
	...
	('Kieran', 'Dawson', 'M', '083 108 4317', 'KieranDawson@rhyta.com', '2000-08-08', '0920', 1, 6),
